...
async function fetchUsers() {
    ...
    try {
        ...
        if(!users) {
            showStatus(usersStatus, "Response에 대한 파싱을 실패했습니다", "error");
            return;
        }
        
        showStatus(usersStatus, `${users.length}명에 대한 데이터를 불러왔습니다.`, "success");
        ...
        showStatus(usersStatus, "데이터를 불러오기를 실패했습니다.", "error");
