...
async function fetchUsers() {
    ...
    showStatus(usersStatus, "유저 데이터를 불러오는 중입니다...", "loading");
    ...
    try {
        ...
        if(users) showStatus(usersStatus, `${users.length}명의 데이터를 불러왔습니다.`, "success");
        ...
        // 6. 에러 발생 시 에러 메시지 표시
        showStatus(usersStatus, `에러발생: ${error.message}`, "error");
